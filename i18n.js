...
export const I18N = {
 ...
 my: {
    ...
    daysShort: ["တနင်္ဂနွေ", "တနင်္လာ", "အင်္ဂါ", "ဗုဒ္ဓဟူး", "ကြာသပတေး", "သောကြာ", "စနေ"],
    now: "ယခု", 
    next: "နောက်တစ်ခု", 
    until: "{time} အထိ", 
    startsIn: "{dur} အကြာတွင် စမည်", 
    on: "{day} {time}", 
    tomorrow: "မနက်ဖြန်",
    free: "လက်ရှိတွင် အစီအစဉ် မရှိပါ", 
    freeSub: "ခဏ အနားယူပါ။", 
    noNext: "ဒီအပတ်အတွက် နောက်ထပ် အစီအစဉ် မရှိတော့ပါ",
    today: "ဒီနေ့", 
    week: "အပတ်စဉ်", 
    add: "ထည့်ရန်", 
    addFirst: "ပထမဆုံး အစီအစဉ် ထည့်ရန်",
    newTitle: "အစီအစဉ်အသစ်", 
    editTitle: "အစီအစဉ် ပြင်ဆင်ရန်",
    name: "အမည်", 
    namePh: "ဥပမာ - ကျောင်း၊ အလုပ်", 
    place: "နေရာ (မထည့်လည်းရပါ)", 
    placePh: "ဥပမာ - Cafe Hana",
    repeats: "ထပ်ခါလုပ်မည့်နေ့များ", 
    weekdays: "တနင်္လာ – သောကြာ", 
    everyday: "နေ့တိုင်း",
    starts: "စတင်ချိန်", 
    ends: "ပြီးဆုံးချိန်", 
    overnight: "နောက်နေ့မှ ပြီးဆုံးမည်",
    color: "အရောင်", 
    remind: "သတိပေးချက်", 
    noRemind: "သတိမပေးပါ", 
    atStart: "စတင်ချိန်တွင်", 
    before: "{n} မိနစ် အလို",
    save: "သိမ်းဆည်းရန်", 
    del: "ဖျက်ရန်", 
    cancel: "မလုပ်တော့ပါ",
    errName: "အမည် ထည့်ပါ။", 
    errDays: "အနည်းဆုံး တစ်ရက် ရွေးချယ်ပါ။", 
    errSame: "စတင်ချိန်နှင့် ပြီးဆုံးချိန် မတူရပါ။",
    confirmDel: "“{name}” ကို အပတ်တိုင်းမှ ဖျက်မှာ သေချာပါသလား?", 
    saved: "သိမ်းဆည်းပြီးပါပြီ", 
    deleted: "ဖျက်ပြီးပါပြီ",
    emptyTitle: "အစီအစဉ် မရှိသေးပါ",
    emptyBody: "ကျောင်း၊ အလုပ် စသည့် အပတ်စဉ် ထပ်ခါလုပ်မည့် အစီအစဉ်များကို ထည့်ပါ။ ယခုနှင့် နောက်လာမည့် အစီအစဉ်များကို Byte က ပြသပေးပါမည်။",
    todayEmpty: "ဒီနေ့အတွက် အစီအစဉ် မရှိပါ။",
    storageWarn: "ဤဘရောက်ဇာတွင် ဒေတာ သိမ်းဆည်း၍ မရပါ။ စာမျက်နှာပိတ်လိုက်ပါက ပြောင်းလဲမှုများ ပျောက်ပျက်သွားပါမည်။",
    footNote: "ဤစက်တွင် သိမ်းဆည်းထားပါသည်။ ဖုန်း အသိပေးချက်များကို နောက်ထပ် Update တွင် ထည့်သွင်းပေးပါမည်။",
    ...
    email: "အီးမေးလ်", 
    sendLink: "ဝင်ရောက်ရန် လင့်ခ် ပို့မည်", 
    sending: "ပို့နေသည်…",
    linkSent: "အီးမေးလ်ထံ ပို့ထားသော လင့်ခ်ကို နှိပ်၍ ဝင်ပါ။", 
    errEmail: "မှန်ကန်သော အီးမေးလ် ထည့်ပါ။",
    signInNote: "အကောင့်ဝင်ထားပါက စက်မျိုးစုံမှ သင့်အစီအစဉ်များကို ရယူနိုင်ပါသည်။ စကားဝှက် မလိုပါ — အီးမေးလ်လင့်ခ်ဖြင့် ဝင်ရောက်နိုင်ပါသည်။",
    syncNote: "အကောင့်ဝင်ထားစဉ် အစီအစဉ်များကို အလိုအလျောက် Sync လုပ်ပေးနေပါမည်။",
    demoText: "ဒီမိုမုဒ် - နမူနာ အပတ်စဉ် ပြသထားခြင်း ဖြစ်သည်။ သင့်အစီအစဉ်များ မပျက်ပါ။",
    demoExit: "ဒီမိုမုဒ်မှ ထွက်ရန်", 
    demoOn: "ဒီမိုမုဒ် ဖွင့်ထားသည်", 
    demoOff: "သင့်အစီအစဉ်သို့ ပြန်ရောက်ပါပြီ",
    demo: {
        school: ["ကျောင်း", "ကျောင်းဝင်း"],
        work: ["အလုပ်", "Cafe Hana"],
        study: ["ညဘက် စာကျက်ချိန်", "အိမ်"],
        gym: ["အားကစားရုံ", "Gym Center"],
        groceries: ["ဈေးဝယ်ခြင်း", "စူပါမားကတ်"]
    },
